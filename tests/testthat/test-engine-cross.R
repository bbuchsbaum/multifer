...
test_that("cross ladder keeps the v1 surface exact-only", {
  expect_false("cross_rank_cap" %in% names(formals(run_cross_ladder)))
  expect_false("cross_rank_cap" %in% names(formals(compile_cross_ladder_plan)))
})
