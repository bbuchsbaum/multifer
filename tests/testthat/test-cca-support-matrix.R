...
#
# Fixture builders and the stress-matrix helpers live in
# helper-cca-fixtures.R so test-cca-parity.R can reuse them.
...
# tested root on every fixture as the negative control.  Helpers
# live in helper-cca-fixtures.R.
